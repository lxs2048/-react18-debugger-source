...
export function shouldSkipHydratableForInstance(instance, type, props) {
...
export function shouldSkipHydratableForTextInstance(instance) {
  return instance.nodeType === ELEMENT_NODE;
}

export function shouldSkipHydratableForSuspenseInstance(instance) {
  return instance.nodeType === ELEMENT_NODE;
}
